...
int main(int argc,      // Number of strings in array argv
	...
	std::string path("../Test/GraphDB/Sketches/Corridor");
	cv::Mat test_model = cv::imread("../Test/GraphDB/Sketches/Corridor/model.png", CV_LOAD_IMAGE_GRAYSCALE);
...
// 					cv::waitKey(0);
				...
				// 	AASS::graphmatch::GraphMatcherClusterFiltered graphmatchold;
					...
					//MY THING
					std::cout << "Planar EVG" << std::endl;
					graphmatch_evg.planarEditDistanceAlgorithm(gp, gp_model);
					
					std::cout << "Planar CUSTOM" << std::endl;
					...
					int uu = 0 ;
					while(uu != 1){
						std::cout << "DONE gie v me u is 1 :" << std::endl;
						cv::waitKey(0);
						std::cin >> uu;
					}
