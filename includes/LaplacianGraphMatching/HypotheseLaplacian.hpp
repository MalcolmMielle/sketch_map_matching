#ifndef COMPARATOR_HYPOTHESELAPLCIAN_MAP
#define COMPARATOR_HYPOTHESELAPLCIAN_MAP
...
namespace AASS{
	namespace graphmatch{
		...
		/**
		 * @brief Object defining a possible matching between two graphmatch::GraphLaplacian
		 *
		...
		protected :
			...
			std::deque< graphmatch::MatchLaplacian > _hypothesis;
			int _dist;
		...
		public :
			...
			HypotheseLaplacian() : _dist(0){};
			HypotheseLaplacian(const std::deque< graphmatch::MatchLaplacian >& h, int d) : _hypothesis(h), _dist(d){};
			...
			void push_back(const graphmatch::MatchLaplacian& pair){_hypothesis.push_back(pair);}
			void push_front(const graphmatch::MatchLaplacian& pair){_hypothesis.push_front(pair);}
			...
			void remove(const graphmatch::MatchLaplacian& to_remove){
				_hypothesis.erase(std::remove(_hypothesis.begin(), _hypothesis.end(), to_remove), _hypothesis.end());
			}
			graphmatch::MatchLaplacian& at(int i){return _hypothesis.at(i);}
			std::deque< graphmatch::MatchLaplacian>::iterator begin(){return _hypothesis.begin();}
			std::deque< graphmatch::MatchLaplacian >::iterator erase(const std::deque< graphmatch::MatchLaplacian>::iterator& it){return _hypothesis.erase(it);};


			std::deque< graphmatch::MatchLaplacian >& getMatches(){return _hypothesis;}
			const std::deque< graphmatch::MatchLaplacian >& getMatches() const {return _hypothesis;}
			 ...
			 *
			 * @param[in] pair : graphmatch::MatchLaplacian that we want to test
			 * @return true if seen, false otherwise
			 *
			 */
			bool isSeen(const graphmatch::MatchLaplacian& pair) const;
			 ...
			 * @return true if seen, false otherwise
			 */
			bool isSeen(const graphmatch::MatchLaplacian& pair, int& index) const;
			 ...
			 */
			bool isCompatible(const graphmatch::HypotheseLaplacian h) const;

			graphmatch::MatchLaplacian& operator[](int i);
			const graphmatch::MatchLaplacian& operator[](const int i) const;
			 ...
			 */
			void fuse(const graphmatch::HypotheseLaplacian& hyp);
			 ...
			 */
			void fuse(const std::deque<graphmatch::HypotheseLaplacian>& clu);
			 ...
			 *
			 * @param[in] gp : graphmatch::GraphLaplacian input
			 * @param[in] gp_model : graphmatch::GraphLaplacian model
			 */
			int updateDistance(AASS::graphmatch::GraphLaplacian& gp, AASS::graphmatch::GraphLaplacian& gp_model) const;
			 ...
			 *
			 */
//			int getSizeSimilarZone(AASS::graphmatch::GraphLaplacian& gp, const AASS::graphmatch::VertexPlace& vertex);

//			int getSizeSimilarZone(graphmatch::GraphLaplacian& gp, const AASS::graphmatch::VertexPlace& vertex, HypotheseLaplacian& zone);



			std::tuple<AASS::graphmatch::MatchLaplacian, AASS::graphmatch::MatchLaplacian> getLinkedMatches(const AASS::graphmatch::MatchLaplacian& match_here);


//			bool shouldReplaceBasedOnCost(const AASS::graphmatch::MatchLaplacian& match_equivalent);
			...
			* @brief draw
			*
			* @param[in] gp_real : graphmatch::GraphLaplacian of the input
			* @param[in] gp_model : graphmatch::GraphLaplacian of the model
			* @param[in] _hypothesis : deque of Match between gp_real and gp_model
			* @param[in] name : windows name
			* @param[in] mat_out : drawing out
			*/
			void drawHypo(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, cv::Mat& mat_out) const;
			...
			* @param[in] name : windows name
			*/
			void drawHypo(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name) const;
			...
			*/
			void drawHypo(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, cv::Mat& mat_out) const;
			...
			* @param[in] scale : scale to resize the graph.
			*/
			void drawHypo(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const;
			...
			* @param[in] name : windows name
			*/
			void drawHypoSlow(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name) const;
			...
			* @param[in] scale : scale to resize the graph.
			*/
			void drawHypoSlow(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const;

			/**
			* @brief init the graphmatch::GraphLaplacian the graphmatch is going ot be working on
			*
			* @param[in] gp : graphmatch::GraphLaplacian input
			* @param[in] gp2 : graphmatch::GraphLaplacian model
			*/
// 			virtual void init(const graphmatch::GraphLaplacian& gp, const graphmatch::GraphLaplacian& gp2);
			...
			void drawLinks(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, cv::Mat& out) const;

			void drawLinks(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const;

			void drawPartialGraphs(graphmatch::GraphLaplacian& gp_real, graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, bool export_flag) const;


		};

		inline bool HypotheseLaplacian::isSeen(const graphmatch::MatchLaplacian& pair) const
		{
		...
		inline bool HypotheseLaplacian::isSeen(const graphmatch::MatchLaplacian& pair, int& index) const
		{
		...
		inline bool HypotheseLaplacian::isSeen(const graphmatch::VertexPlace& vp, int& index) const
		{
			for(size_t i = 0 ; i < _hypothesis.size() ; i++){
		...
		inline graphmatch::MatchLaplacian& HypotheseLaplacian::operator[](int i)
		{
			return _hypothesis[i];
		}
		inline const graphmatch::MatchLaplacian& HypotheseLaplacian::operator[](const int i) const
		{
			return _hypothesis[i];
		}

		inline bool HypotheseLaplacian::isCompatible(const HypotheseLaplacian h) const
		{

			bool compatible = true;
			std::deque< graphmatch::MatchLaplacian > match_h;
			match_h = h.getMatches();

			std::deque< graphmatch::MatchLaplacian >::iterator it;
		...
		inline void HypotheseLaplacian::fuse(const HypotheseLaplacian& hyp)
		{
			std::deque<graphmatch::MatchLaplacian>::const_iterator it;
		...
		inline void HypotheseLaplacian::fuse(const std::deque<graphmatch::HypotheseLaplacian>& clu)
		{
			std::deque<graphmatch::HypotheseLaplacian>::const_iterator it;
...
//		inline int HypotheseLaplacian::getSizeSimilarZone(graphmatch::GraphLaplacian& gp, const AASS::graphmatch::VertexPlace& vertex, HypotheseLaplacian& zone){
//
//			/* Do a partial A* */
...
//
//			if(index_vertex == -1){
//				throw std::runtime_error("Vertex is not part of the hypothese. Error in HypotheseLaplacian::getSizeSimilarZone");
//			}
//
//			while(queue.size() != 0){
//
...
//
//
//		inline int HypotheseLaplacian::getSizeSimilarZone(graphmatch::GraphLaplacian& gp, const AASS::graphmatch::VertexPlace& vertex)
//		{
//
//			HypotheseLaplacian hyp;
...
//		}
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawHypo(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, cv::Mat& mat_out) const
		{
...
//			gp_model.scale(scale);
			...
			for(size_t i = 0 ; i < _hypothesis.size() ; i++ ){
				...
				cv::line(draw_links, gp_real[_hypothesis[i].getFirst()].getCenter(), gp_model[_hypothesis[i].getSecond()].getCenter(), color);


				//UGLY HACK BECAUSE THE SCALING DOESN'T WORK
				cv::Point2i model_normal;
				model_normal = gp_real[_hypothesis[i].getFirst()].getCenter();

				cv::Point2i model = gp_model[_hypothesis[i].getSecond()].getCenter();
...
// 			cv::imshow(name + " maps", all_maps);
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawHypo(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, cv::Mat& mat_out) const
		{
			drawHypo(gp_real, gp_model, obstacle, obstacle_model, name, 1, mat_out);
		}

		inline void AASS::graphmatch::HypotheseLaplacian::drawHypo(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name) const
		{
			cv::Mat tmp;
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawHypo(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const
		{
			cv::Mat tmp;
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawHypoSlow(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name) const
		{
			drawHypoSlow(gp_real, gp_model, obstacle, obstacle_model, name, 1);
		}


		inline void AASS::graphmatch::HypotheseLaplacian::drawHypoSlow(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const
		{
			...
			for(size_t i = 0 ; i < _hypothesis.size() ; i++ ){
				...
				cv::Point2i model;
				model = gp_model[_hypothesis[i].getSecond()].getCenter();
				model.y = model.y + obst_copy.size().height;
...
//			gp_model.scale(1/scale);
		...
		inline void HypotheseLaplacian::drawMoved(const GraphPlace& gp_real_const, const GraphPlace& gp_model_const, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, int scale) const
		{
			...
			std::deque< MatchLaplacian > list_result = _hypothesis;
			std::deque< MatchLaplacian > list_result_real = _hypothesis;
...
// 			cv::imshow(name + " maps", all_maps);
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawLinks(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale) const{
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawLinks(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, cv::Mat& out) const
		{
...
//			gp_model.scale(1/scale);
		...
		inline void AASS::graphmatch::HypotheseLaplacian::drawPartialGraphs(AASS::graphmatch::GraphLaplacian& gp_real, AASS::graphmatch::GraphLaplacian& gp_model, const cv::Mat& obstacle, const cv::Mat& obstacle_model, const std::string& name, double scale, bool export_flag) const
		{
...
//			gp_model.scale(1/scale);
		...
		inline std::ostream& operator<<(std::ostream& os, const AASS::graphmatch::HypotheseLaplacian& dt){
			os << "Hypothese Laplacian" << std::endl;
