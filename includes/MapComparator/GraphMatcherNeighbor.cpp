...
int AASS::graphmatch::GraphMatcherNeighbor::initPlanar(const AASS::graphmatch::Match& the_pair, AASS::graphmatch::Hypothese& starting_seeds, AASS::graphmatch::Hypothese& Q, AASS::graphmatch::Hypothese& seen_before, graphmatch::GraphPlace& gp, graphmatch::GraphPlace& gp_model)
{
			//Match neighborhoods
...
// 			std::cout << "Result : " << operation << std::endl;
			...
			for(size_t i = 0 ; i < out.size() ; i++){
				...
				if(starting_seeds.isSeen(out[i], index_out) == true){
...
bool AASS::graphmatch::GraphMatcherNeighbor::planarEditDistanceAlgorithm(graphmatch::GraphPlace& gp, graphmatch::GraphPlace& gp_model)
{
...
bool AASS::graphmatch::GraphMatcherNeighbor::planarEditDistanceAlgorithm(graphmatch::Hypothese& starting_seeds, graphmatch::GraphPlace& gp, graphmatch::GraphPlace& gp_model)
{
...
// 		drawHypo(gp, gp_model, mat_in, mat_in, Q.getMatches(), "the seed", 2);
		...
		graphmatch::Match the_pair_init(Q[0].getFirst(), Q[0].getSecond());
...
// 			std::cout << "Going to make the match" << std::endl;
			...
			std::deque< graphmatch::Match > out_match;
			dist = dist + graphmatch::makeMatching(the_pair.getFirst(), 
						the_pair.getSecond(), 
						gp, 
						gp_model, 
